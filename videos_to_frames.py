...
if __name__ == '__main__':
    root_path = '.\\kinetics400_5per\\train'
    ...
    for category_path in categories_paths: 
        ...
        video_path = os.path.join(root_path,category_path)#'/home/raivo/data1/kinetics/videos/all'
        # the root output path where RGB frame folders should be created
        rgb_out_path = video_path+'\\frames'
